...
if($_FILES['foto']['error'] == 0){
	if($_FILES['foto']['size'] < 1000000){
		...
		$query = mysqli_query($koneksi, "INSERT INTO tbl_siswa (nama, nis, password , jenis_kelamin, tempat_lahir, tanggal_lahir, alamat, no_hp, foto, id_jurusan) VALUES('$nama', $nis, , $nis '$jenis_kelamin', '$tempat_lahir', '$tanggal_lahir', '$alamat', '$no_hp', '$nama_foto', '$id_jurusan')") or die(mysqli_error($koneksi));
