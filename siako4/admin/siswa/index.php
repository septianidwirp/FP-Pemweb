...
$query = mysqli_query($koneksi, "SELECT tbl_siswa.id, tbl_siswa.nama, tbl_siswa.nis, tbl_siswa.password, tbl_siswa.no_hp, tbl_siswa.foto, tbl_siswa.alamat, tbl_jurusan.mapel AS mapel FROM tbl_siswa LEFT JOIN tbl_jurusan ON tbl_siswa.mapel = tbl_jurusan.id_mapel");
$no = 1;
$active = 'master';
?>
<!DOCTYPE html>
