...
$id = $_GET['id'];
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT tbl_siswa.*, tbl_jurusan.mapel as matapelajaran FROM tbl_siswa LEFT JOIN tbl_jurusan ON tbl_siswa.mapel = tbl_jurusan.id_mapel WHERE tbl_siswa.id = $id");
